...
public class ViewPostFragment extends Fragment {
    ...
    private User_SignUp mCurrentUser;
...
//
//                                        singleSnapshot.getValue(User_SignUp.class).getUser_Name());

                               mUsers.append(singleSnapshot.getValue(User_SignUp.class).getUser_Name());

                                mUsers.append(",");

                            }

//                            mUsers.append(dataSnapshot.getValue(User_SignUp.class).getUser_Name());
//                            mUsers.append(",");

//                            Toast.makeText(getActivity(), "UserName "+ mUsers, Toast.LENGTH_SHORT).show();

                            String[] splitUsers = mUsers.toString().split(",");

//                            mLikedByCurrentUser = true;
                            if(mUsers.toString().contains(dataSnapshot.getValue(User_SignUp.class).getUser_Name() + ",")){//mitch, mitchell.tabian
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for ( DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                    ...
                    mCurrentUser = singleSnapshot.getValue(User_SignUp.class);
...
///
    ...
    private void getPhotoDetails(){
        ...
        Query query = reference
                ...
                .child(getString(R.string.user_account_setting))
...
//
    ...
    private String getTimestampDifference(){
        ...
        sdf.setTimeZone(TimeZone.getTimeZone("Asia/Kolkata"));//google 'android list of timezones'
