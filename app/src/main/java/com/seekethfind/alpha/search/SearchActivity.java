package com.seekethfind.alpha.search;
...
import com.seekethfind.alpha.util.UserListAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private List<User_SignUp> mUserList;
    ...
    private void searchForMatch(String keyword){
        ...
        if(keyword.length() ==0){
            ...
            Query query = reference.child(getString(R.string.user_account_setting))
                    .orderByChild(getString(R.string.field_username_setting)).equalTo(keyword);
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for(DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                        ...
                        String name = singleSnapshot.getValue(UserAccountSettings.class).getUser_id();

//                        Toast.makeText(mContext, "Username "+ name, Toast.LENGTH_SHORT).show();
                        ...
                        query.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                mUserList.add(dataSnapshot.getValue(User_SignUp.class));
